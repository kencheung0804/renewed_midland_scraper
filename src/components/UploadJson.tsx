...
import { choiceReferenceName, LookUpTables, LookUpTableTypes } from "../utils/constants";
  ...
  export default function UploadJson(): JSX.Element {
    ...
    const [selectedChoice, setSelectedChoice] = useState<LookUpTableTypes| null>(null);
    ...
    useEffect(() => {
      const getStoreFromElectron = (e:Electron.IpcRendererEvent , item: LookUpTables) => {
        setStore(item);
      };
      ...
      <Frame>
        <FormControl className={classes.select}>
          ...
          <Select
            ...
            onChange={(e:React.ChangeEvent<HTMLSelectElement>) => setSelectedChoice(e.target.value as LookUpTableTypes)}
          >
            {choices.map((c, index) => (
