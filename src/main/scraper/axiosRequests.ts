...
export const axiosMidlandResidentialData = async ({ t, token, targetArea }: axiosMidlandResidentialDataArgs) : Promise<any> => {
  ...
  export const axiosMilandCommercialData = async ({
    ...
    const tx = midlandCommercialQueriesDict.transaction[t];
    const icsType = midlandCommercialQueriesDict.usage[usage as UsageTypes.Office | UsageTypes.Commercial];
